    ...
    while(repetir):
        ...
        for i in range(len(df_inputs)):
            ...
            if (y != clase):
                ...
                pesos = ajuste_de_pesos(arr,0.2,error,pesos)
                print(pesos)
                break
            if (i==max(range(len(df_inputs)))) and (y == clase):
                print("Terminado")
                repetir = False
                break
